...
import type { Levels } from "../../components/headline"
import type { BuenType } from "./generateBuenType"

const defaultTheme = require("tailwindcss/defaultTheme")

const { generateBuenTypeCustomProperties, generateBuenType } = require("./") // Adjust the path as needed
